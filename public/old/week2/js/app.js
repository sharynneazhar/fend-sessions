...
absolutePathForm.addEventListener("submit", (e) =>
  handleInput(e, "absolute-path-input")
);
...
somewhereElseForm.addEventListener("submit", (e) =>
  handleInput(e, "somewhere-else-input")
);
...
nestedForm.addEventListener("submit", (event) => {
  ...
  if (
    inputValue ===
    "../../nested/nested-again/nested-again-again/costume-pup.jpeg"
  ) {
    image.src =
      "/fend-sessions/old/nested/nested-again/nested-again-again/costume-pup.jpeg";
  } else {
    image.src = "wrongpath";
  }
